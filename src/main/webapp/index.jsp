...
<body>
	...
	<h1 style="color: blue; font-size: 40px;" align="center">hello my name is subhash</h1>
	<h1 style="color: violet; font-size: 40px;" align="center">HEY WE DEPLOYED OUR APP IN TOMCAT USING JENKINS</h1>
